...
\newcommand{\supervisor}{Prof. Dr. Subarna Shakya} % Specify Name of Supervisor for Major Project
\newcommand{\degSup}{Professor\\Department of Electronics and Computer Engineering, IOE Pulchowk Campus} %Specify Designation of Supervisor for Major Project, use multiple lines (\\) if necessary
